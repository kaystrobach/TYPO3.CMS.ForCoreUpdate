...
class Tx_Install_Service_BasicService {
	...
	/** 
	 * check if the "FIRST_INSTALL" file exists,
	 * if so, delete it, and add the enable install tool file
	 *
	 * @return void
	 */
	protected static function checkFirstInstallFile() {
	 ...
	 * @return boolean
	 */
	public static function isInstallToolPasswordEmpty() {
		return (empty($GLOBALS['TYPO3_CONF_VARS']['BE']['installToolPassword']));
	}

	/**
	 * touches the ENABLE_INSTALL_TOOL file
	 * 
	 * return void
	 */
	public static function extendInstallToolEnableFileLifetime() {
		$enableFile = self::getInstallToolEnableFilePath();
