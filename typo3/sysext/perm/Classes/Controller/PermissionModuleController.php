...
class SC_mod_web_perm_index {
	...
	public function doEdit() {
		if ($GLOBALS['BE_USER']->workspace != 0) {
			...
			$lockedMessage = t3lib_div::makeInstance('t3lib_FlashMessage', $GLOBALS['LANG']->getLL('WorkspaceWarningText'), $GLOBALS['LANG']->getLL('WorkspaceWarning'), t3lib_FlashMessage::WARNING);
		...
		$code = ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((('
			...
			<input type="submit" name="submit" value="') . $GLOBALS['LANG']->getLL('Save', 1)) . '" />') . '<input type="submit" value="') . $GLOBALS['LANG']->getLL('Abort', 1)) . '" onclick="') . htmlspecialchars((('jumpToUrl(' . t3lib_div::quoteJSvalue(((t3lib_BEfunc::getModuleUrl('web_perm') . '&id=') . $this->id), TRUE)) . '); return false;'))) . '" />
			<input type="hidden" name="redirect" value="') . htmlspecialchars(((((((((t3lib_BEfunc::getModuleUrl('web_perm') . '&mode=') . $this->MOD_SETTINGS['mode']) . '&depth=') . $this->MOD_SETTINGS['depth']) . '&id=') . intval($this->return_id)) . '&lastEdited=') . $this->id))) . '" />
