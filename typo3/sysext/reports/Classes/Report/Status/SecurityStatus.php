...
class tx_reports_reports_status_SecurityStatus implements tx_reports_StatusProvider {
	...
	protected function getAdminAccountStatus() {
		...
		$whereClause = ('username = ' . $GLOBALS['TYPO3_DB']->fullQuoteStr('admin', 'be_users')) . t3lib_BEfunc::deleteClause('be_users');
	...
	protected function getEncryptionKeyStatus() {
		...
		return t3lib_div::makeInstance('tx_reports_reports_status_Status', $GLOBALS['LANG']->getLL('status_encryptionKey'), $value, $message, $severity);
	}
	...
	protected function getFileDenyPatternStatus() {
		...
		return t3lib_div::makeInstance('tx_reports_reports_status_Status', $GLOBALS['LANG']->getLL('status_fileDenyPattern'), $value, $message, $severity);
	}
	...
	protected function getHtaccessUploadStatus() {
		...
		return t3lib_div::makeInstance('tx_reports_reports_status_Status', $GLOBALS['LANG']->getLL('status_htaccessUploadProtection'), $value, $message, $severity);
	}
	...
	protected function getInstallToolPasswordStatus() {
		...
		return t3lib_div::makeInstance('tx_reports_reports_status_Status', $GLOBALS['LANG']->getLL('status_installToolPassword'), $value, $message, $severity);
	}
	...
	protected function getSaltedPasswordsStatus() {
		...
		return t3lib_div::makeInstance('tx_reports_reports_status_Status', $GLOBALS['LANG']->getLL('status_saltedPasswords'), $value, $message, $severity);
	}
	...
	protected function getInstallToolProtectionStatus() {
		...
		if ($enableInstallToolFileExists) {
			if (trim(file_get_contents($enableInstallToolFile)) === 'KEEP_FILE') {
				$severity = tx_reports_reports_status_Status::WARNING;
				$disableInstallToolUrl = t3lib_div::getIndpEnv('TYPO3_REQUEST_URL') . '&amp;adminCmd=remove_ENABLE_INSTALL_TOOL';
		...
		return t3lib_div::makeInstance('tx_reports_reports_status_Status', $GLOBALS['LANG']->getLL('status_installTool'), $value, $message, $severity);
	}
