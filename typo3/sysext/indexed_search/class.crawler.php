 ...
 */
require_once t3lib_extMgm::extPath('indexed_search') . 'Classes/Hook/CrawlerHook.php';
/*
 ...
 */
require_once t3lib_extMgm::extPath('indexed_search') . 'Classes/Hook/CrawlerFilesHook.php';
?>