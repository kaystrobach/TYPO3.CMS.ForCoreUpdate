...
'	function openPic(url,winName,winParams)	{	//
	...
	function convPOSTCharset()	{
	 ...
	 /**
	  * Returns the domain data (originating from sys_domain) for a certain target page.
	  *
	  * @param $targetPid Target page id
	  * @return mixed
	  */
	public function getDomainDataForPid($targetPid) {
	 ...
	 /**
	  * Returns the domain name for the requested page
	  *
	  * @param $targetPid Target page id
	  * @return mixed
	  */
