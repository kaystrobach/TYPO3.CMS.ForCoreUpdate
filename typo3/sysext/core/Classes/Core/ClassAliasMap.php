...
class ClassAliasMap implements \TYPO3\CMS\Core\SingletonInterface {
	 ...
	 * @var array
	 */
	static protected $aliasToClassNameMapping;

	/**
	 * @var array
	 */
	static protected $classNameToAliasMapping;
	...
	static public function setAliasForClassName($aliasClassName, $originalClassName) {
		static::$aliasToClassNameMapping[strtolower($aliasClassName)] = $originalClassName;
		static::$classNameToAliasMapping[strtolower($originalClassName)][] = $aliasClassName;
