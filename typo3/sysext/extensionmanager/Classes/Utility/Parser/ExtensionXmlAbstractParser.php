...
abstract class Tx_Extensionmanager_Utility_Parser_ExtensionXmlAbstractParser extends Tx_Extensionmanager_Utility_Parser_XmlAbstractParser {
	 ...
	 * @var  string
	 */
	protected $extensionDLCounter = NULL;
	 ...
	 * @var  string
	 */
	protected $versionDLCounter = NULL;
	...
	public function getAll() {
		...
		$versionProperties['alldownloadcounter'] = $this->extensionDLCounter;
		$versionProperties['downloadcounter'] = $this->versionDLCounter;
	...
	public function getAlldownloadcounter() {
		return $this->extensionDLCounter;
	}
	...
	protected function resetProperties($resetAll = FALSE) {
		...
		$this->version = $this->title = $this->versionDLCounter =
		...
		if ($resetAll) {
			$this->extensionKey = $this->extensionDLCounter = NULL;
		}
	}
